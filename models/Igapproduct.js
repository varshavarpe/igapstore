...
class Igapprduct {
    ...
    get=()=>{
        this.query = "SELECT * FROM igapproductcategories WHERE id = "+this.id;
        console.log(this.query);
        return new Promise((resolve, reject)=>{
            this.db.query(this.query, (err, result)=>{
                this.db.close();
    ...
    list=()=>{
        this.query =  "SELECT * FROM igapproductcategories ";
        console.log(this.query);
        return new Promise((resolve, reject)=>{
            this.db.query(this.query, (err, result)=>{
                this.db.close();
    ...
    delete=()=>{
        this.query = "DELETE FROM igapproductcategories  WHERE id = "+this.id+"";
